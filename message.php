...
// Lấy id người dùng chi tiết (người nhận)
...
// Cập nhật tin nhắn (chỉ cho phép chỉnh sửa tin nhắn của chính mình)
...
// Lấy danh sách tin nhắn cho người dùng chi tiết
    ...
    <?php while ($row = $result->fetch_assoc()): ?>
      <div style="border-bottom:1px solid #ccc; margin-bottom:10px;">
        ...
        <?php if ($row['sender_id'] == $_SESSION['user']['id']): ?>
          <!-- Form sửa và xóa tin nhắn của chính người gửi -->
