...
// Chỉ giáo viên mới được truy cập trang này
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] != 'teacher') {
    die("Access denied.");
}

$teacher_id = $_SESSION['user']['id'];
// Lấy assignment_id từ GET (nếu có)
$assignment_id = isset($_GET['assignment_id']) ? intval($_GET['assignment_id']) : 0;

// Nếu đã chọn bài tập, truy vấn các bài làm (submissions)
$submissions = null;
if ($assignment_id > 0) {
...
// Truy vấn danh sách bài tập của giáo viên để lọc (cho dropdown)
...
<head>
    ...
    <!-- CSS riêng cho trang teacher_view_submissions -->
    <style>
        .filter-form {
            max-width: 600px;
            margin: 20px auto;
